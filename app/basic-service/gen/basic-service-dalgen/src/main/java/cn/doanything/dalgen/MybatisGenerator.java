...
public class MybatisGenerator {
    ...
    public static void gen(Config config, String projectPath) {
        String classDir = projectPath + "/app/basic-service-infrastructure/src/main/java";
        String xmlDir = projectPath + "/app/basic-service-infrastructure/src/main/resources/mapper";
